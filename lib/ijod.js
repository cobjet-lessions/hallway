...
exports.getChunks = function(basePath, range, cbEach, cbDone) {
  ...
  var sql = "SELECT path FROM Chunks WHERE base = unhex(?) and ((at1 < ? and at2 > ?) or (at1 < ? and at2 > ?) or (at1 > ? and at2 < ?) or (at1 < ? and at2 > ?)) order by at2 desc";
  var binds = [
    idr.baseHash(basePath),
    at1, at1, // oldest is between at1 and at2 
    at2, at2, // newest is between at1 and at2
    at1, at2, // old+new is around at1/at2
    at1, at2 // old+new is inside at1/at2
  ];
